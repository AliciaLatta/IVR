...
#Region "Variables"
    ...
    Private Const ProgramError As String = "There was a problem with the program.  Please try again."
...
#End Region
    ...
    Private Class Trans
        ...
        Friend Function ProcessRow(ByVal reportFilePath As String, ByVal outputWriter As StreamWriter, _
            ...
            If Trim(ConfigurationSettings.AppSettings("CallLogic").ToString.ToUpper) = "ALLBUT" Then
                ...
                If processedCounter = 0 Then
                    ...
                    name = Trim(Left(_row, 28))
                    space = name.IndexOf(" ")
                    If name.Length > 0 Then
                        If space > 0 Then
                            firstName = Trim(Left(name, space))
                        Else
                            firstName = Trim(Left(name, 9))
                        End If
                    End If
                    ...
                    If scheduledDaysPrior <> "" Then
                        ...
                        Else
                            WriteAllButRecord(strPhone, strNewPhone, providerID, apptDate, skipMeeting, msgID, firstName, outputWriter)
                        End If
                    Else
                        WriteAllButRecord(strPhone, strNewPhone, providerID, apptDate, skipMeeting, msgID, firstName, outputWriter)
                    End If
                Else
                    ...
                    If Not _row.Trim.Length > 1 Then
                        ...
                        End If
                    End If
                    If _row.Chars(1).IsLetter(_row.Chars(1)) Then
                    ...
                    If scheduledDaysPrior <> "" Then
                        ...
                        Else
                            ...
                            If useCSV = False Then
                                WriteNoneButRecord(strPhone, strNewPhone, providerID, apptDate, skipMeeting, msgID, firstName, outputWriter)
                            Else
                                WriteNoneButRecord(strPhone, strNewPhone, providerID, apptDate, skipMeeting, msgID, firstName, outputWriter)
                            End If
                        End If
        ...
        Private Function FormatPhone(ByVal strPhone As String, ByRef name As String, ByRef exceptionWriter As StreamWriter) As String
            ...
            If strNewPhone.Length <> 10 Then
                If strNewPhone.Length = 7 Then
                    strNewPhone = ConfigurationSettings.AppSettings("DefaultAreaCode").ToString & strNewPhone
                    If name <> "written" Then
                        exceptionWriter.WriteLine("Area code is missing: " & name & " " & strNewPhone)
                    End If
                Else
                    If name <> "written" Then
                        exceptionWriter.WriteLine("Invalid phone number: " & name & " " & strNewPhone)
        ...
        Private Sub WriteAllButRecord(ByVal strPhone As String, ByVal strNewPhone As String, ByVal providerID As String, _
                        ByVal apptDate As Date, ByVal skipMeeting As Boolean, ByVal msgID As String, ByVal firstName As String, ByRef outputWriter As StreamWriter)
